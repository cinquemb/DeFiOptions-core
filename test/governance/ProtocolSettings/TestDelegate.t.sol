...
contract TestDelegate is Base {
    ...
    function testDelegateBalance() public {
        ...
        ShareHolder s1 = new ShareHolder(address(settings), address(govToken), address(manager));
        ShareHolder s2 = new ShareHolder(address(settings), address(govToken), address(manager));
        ShareHolder s3 = new ShareHolder(address(settings), address(govToken), address(manager));
