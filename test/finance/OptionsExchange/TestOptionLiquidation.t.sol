...
contract TestOptionLiquidation is Base {
    ...
    function testPartialLiquidationWhenIssuerLacksCollateral() public {
        ...
        collateralManager.liquidateOptions(_tk, address(bob));
    ...
    function testMultipleLiquidationsWhenIssuerLacksCollateral() public {
        ...
        uint v1 = collateralManager.liquidateOptions(_tk, address(bob));
        ...
        uint v2 = collateralManager.liquidateOptions(_tk, address(bob));
        ...
        uint v3 = collateralManager.liquidateOptions(_tk, address(bob));
