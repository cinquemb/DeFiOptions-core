...
contract Swap is OwnerPausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    /**
     * @notice Modifier to check that msg.sender is liquidity swap contract set
     */
    ...
    function mintForLiquidtySwap(uint256 underlyingDesiredTokenAmount) external payable virtual onlyLiquiditySwap {
        /*
     ...
     */
    function setLiquiditySwapAddr(address addr) external payable onlyOwner {
